                                ...
                                <div className="cat-left">
                                    <div className="image-cat">
                                        <Link href="/blog-archive">
                                            <Image width={32} height={32} src="/assets/imgs/page/healthy/cat1.png" alt="Genz" />
                                        </Link>
                                    </div>
                                ...
                                <div className="cat-left">
                                    <div className="image-cat">
                                        <Link href="/blog-archive-2">
                                            <Image width={32} height={32} src="/assets/imgs/page/healthy/cat2.png" alt="Genz" />
                                        </Link>
                                    </div>
                                    <div className="info-cat">
                                ...
                                <div className="cat-left">
                                    <div className="image-cat">
                                        <Link href="/blog-archive-3">
                                            <Image width={32} height={32} src="/assets/imgs/page/healthy/cat3.png" alt="Genz" />
                                        </Link>
                                    </div>
                                    <div className="info-cat">
                                ...
                                <div className="cat-left">
                                    <div className="image-cat">
                                        <Link href="/blog-archive-4">
                                            <Image width={32} height={32} src="/assets/imgs/page/healthy/cat4.png" alt="Genz" />
                                        </Link>
                                    </div>
                                    <div className="info-cat">
                                ...
                                <div className="cat-left">
                                    <div className="image-cat">
                                        <Link href="/blog-archive-5">
                                            <Image width={32} height={32} src="/assets/imgs/page/healthy/cat5.png" alt="Genz" />
                                        </Link>
                                    </div>
                                    <div className="info-cat">
