                ...
                <div className="mobile-header-wrapper-inner">
                    <div className="mobile-header-content-area">
                        ...
                        <div className="perfect-scroll">
                                    ...
                                    <ul className="mobile-menu font-heading">
                                        ...
                                        <li className={isActive.key == 5 ? "has-children active" : "has-children"} onClick={() => handleToggle(5)}>
                                            ...
                                            <ul className={isActive.key == 5 ? "sub-menu d-block" : "sub-menu d-none"}>
                                                ...
                                                <li><Link className="color-gray-500" href="/portfolio-2">My Portfolio 2</Link></li>
                                ...
                                <div className="mobile-header-top bg-gray-900">
                                    <div className="user-account">
                                        <Link href="/page-login">
                                            <Image width={48} height={48} src="/assets/imgs/template/ava.jpg" alt="GenZ" />
                                        </Link>
                            ...
                            <div className="site-copyright color-gray-400 mt-30">Copyright 2025 © Genz - Personal Blog
