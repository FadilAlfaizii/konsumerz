                            ...
                            <div className="card-blog-1 hover-up">
                                <div className="card-image mb-20"><Link className="post-type" href={`/blog/${item.id}`} />
                                    <Link href={`/blog/${item.id}`}>
                                        <Image width={470} height={292} src={`/assets/imgs/page/homepage2/${item.img}`} alt="Genz" />
                                    </Link>
                                </div>
                                <div className="card-info">
                                    ...
                                    <div className="row align-items-center mt-25">
                                        <div className="col-7">
                                            <div className="box-author"><Image width={48} height={48} src="/assets/imgs/page/homepage1/author.jpg" alt="Genz" />
                                                <div className="author-info">
                                                    <h6 className="color-gray-700">Joseph</h6><span className="color-gray-700 text-sm">25 April 2025</span>
                                                </div>
                                            </div>
                                        </div>
