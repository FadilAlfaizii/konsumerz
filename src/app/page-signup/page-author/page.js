...
import Hero6 from "@/components/sections/Hero3"
                                                    ...
                                                    <div className="card-blog-1 hover-up wow animate__animated animate__fadeIn">
                                                        <div className="card-image mb-20">
                                                            ...
                                                            <Link href={`/blog/${item.id}`} >
                                                                <Image width={484} height={274} src={`/assets/imgs/page/travel-tip/${item.img}`} alt="Genz" />
                                                            </Link>
                                                        </div>
                                                            ...
                                                            <div className="row align-items-center mt-25">
                                                                <div className="col-7">
                                                                    <div className="box-author">
                                                                        <Image width={48} height={48} src={`/assets/imgs/page/homepage1/${item.author}`} alt="Genz" />
                                                ...
                                                <div className="col-lg-4" key={i}>
                                                    <div className="card-blog-1 hover-up wow animate__animated animate__fadeIn">
                                                        <div className="card-image mb-20"><Link className="post-type" href="#" />
                                                            <Link href={`/blog/${item.id}`} ><Image width={300} height={186} src={`/assets/imgs/page/travel-tip/${item.img}`} alt="Genz" /></Link></div>
                                                        <div className="card-info">
                                                            <div className="row">
